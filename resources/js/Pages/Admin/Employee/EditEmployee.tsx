...
const EditEmployee: React.FC<EditEmployeeProps> = ({
    ...
    const [isLoading, setIsLoading] = useState(false); // Estado para el loading spinner
    ...
    const handleCloseSuccessModal = () => {
        ...
        onSuccess(); // Llama a onSuccess para recargar el componente después de confirmar el éxito
    };

    const onSubmit = (data: any) => {
        setIsLoading(true); // Activar el loading spinner
        ...
        axios.patch(`/admin/employees/${employee.id}`, payload)
            ...
            .finally(() => {
                setIsLoading(false); // Desactivar el loading spinner
            });
    };
                    ...
                    <Controller
                        ...
                        rules={{
                            ...
                            pattern: {
                                ...
                                message: 'El número de teléfono debe ser válido de México o EE. UU., comenzando con + y código de área'
                            }
                        }}
                        render={({field}) => (
                            <input
                ...
                <dialog open className="modal">
                    <div className="modal-box">
                        ...
                        <div className="modal-action">
                            <button className="btn btn-primary" onClick={handleCloseSuccessModal}>Aceptar</button>
                        </div>
                    </div>
                </dialog>
            )}
