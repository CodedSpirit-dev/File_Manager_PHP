 ...
 * @param {string} newFilename - Nuevo nombre para el archivo.
 * @param {string} path - Ruta donde se encuentra el archivo.
 * @returns {Promise<Object>} - Respuesta del servidor.
 */
export const renameFile = async (oldFilename: string, newFilename: string, path: string): Promise<any> => {
    try {
        const response = await axios.post(`${FILEMANAGER_PREFIX}/files/rename-file`, {
